...
import kotlinx.android.synthetic.main.q2.*

class ques2: AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.q2)
        val b1: Button = findViewById(R.id.qb2)
        b1.setOnClickListener { sub1() }
        val b2: Button = findViewById(R.id.qn2)
        b2.setOnClickListener { nxt1() }
        val b3:Button=findViewById(R.id.f2)
    ...
    private fun sub1(){var result=""
        if(ra23.isChecked)
        {
            ...
            val dialog: AlertDialog =builder.create()
            dialog.show()
            val intent= Intent(this,ques3::class.java)
            startActivity(intent)
        }
        else{
