...
import kotlinx.android.synthetic.main.q4.*


class ques4: AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.q4)
        val b1: Button = findViewById(R.id.qb4)
        b1.setOnClickListener { sub1() }
        val b2: Button = findViewById(R.id.qn4)
        b2.setOnClickListener { nxt1() }
        val b3:Button=findViewById(R.id.f4)
    ...
    private fun sub1(){
        ...
        if(ra41.isChecked)
        {
            ...
            val dialog: AlertDialog =builder.create()
            dialog.show()
            val intent= Intent(this,ques5::class.java)
            startActivity(intent)
        }
        else{
